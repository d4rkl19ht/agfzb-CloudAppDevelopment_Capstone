...
urlpatterns = [
    ...
    path(route='dealer/review/view/<dealer_id>', view=views.get_dealer_details, name='review'),

    # path for add a review view
    path(route='dealer/review/post/<dealer_id>', view=views.add_review, name='add_review'),
